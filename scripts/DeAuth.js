...
async function main(){
    ...
    await deAuth.connect(user1).connectNewSocialMedia("reddit","metamask",user1.address);
    await deAuth.connect(user1).connectNewSocialMedia("twitter","metamask",user1.address);
    console.log("User 1 social media that connected to DeAuth (address = user1) =>",(await deAuth.getConnectedSocialMedias(user1.address,"metamask")));
    console.log("User 1 social media that connected to DeAuth (address = user1New) =>",(await deAuth.getConnectedSocialMedias(user1New.address,"metamask")));
